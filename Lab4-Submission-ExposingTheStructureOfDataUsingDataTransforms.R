...
# Execute the following to load the “BI1 Student performance” dataset which is offered
# in the "data" folder:
...
### The Scale Basic Transform on the BI1 Student performance  Dataset ----
# BEFORE
summary(StudentPerformanceDataset)
hist(StudentPerformanceDataset[c, 75], main = names(StudentPerformanceDataset)[c, 75])
...
hist(StudentPerformanceDataset[, 5], main = names(StudentPerformanceDataset)[5])
hist(StudentPerformanceDataset[, 6], main = names(StudentPerformanceDataset)[6])
...
hist(StudentPerformanceDataset[, 14], main = names(StudentPerformanceDataset)[14])
